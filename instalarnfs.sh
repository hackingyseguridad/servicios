...
#
# /tmp/ (rw,sync)
# /var/www/html/ 192.168.1.47(sync,rw) 192.168.1.48(sync,ro,root_squash) 127.0.0.1(sync, rw, no_root_squash) 192.168.1.50(rw)
#
...
# sudo mount -t nfs4 192.168.1.200:/var/www/html mnt/web/
